...
```bash
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode devices
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode assemble
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode lint
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode unit
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode connected
python3 docs/how-to/operate/skills-src/android-build-verify/scripts/run_android_verify.py --workspace "$PWD" --mode full-local
```
