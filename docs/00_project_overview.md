...
当前 `docs/` 目录采用轻量结构化管理方式：

- `00_project_overview.md`：当前总览
- `01_prd/`：需求文档
- `02_specs/`：技术方案文档
- `03_tasks/`：任务文档
- `04_runbooks/`：运行与排障文档
- `05_handoffs/`：阶段性交接文档
- `06_decisions/`：关键决策记录
- `archive_openclaw/`：历史 OpenClaw 专项资料
...
1. 更新 `01_prd/v1_reference_notes.md`
2. 更新 `01_prd/ai_sales_assistant_v1_prd.md`
3. 新增第一版系统架构 spec
4. 新增关键部署/数据权威 decision 文档
5. 再拆第一个正式产品任务
