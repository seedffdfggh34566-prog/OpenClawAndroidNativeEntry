...
它属于 `docs/02_specs/`，用于把当前已经明确的方向进一步落成可指导后续 task 与实现的技术方案说明。
...
V1 核心正式业务对象以 [v1_domain_model_baseline.md](/home/yulin/projects/OpenClawAndroidNativeEntry/docs/02_specs/v1_domain_model_baseline.md) 为准。
