...
- 建议路径：`docs/03_tasks/task_v1_android_control_shell_refactor.md`
- 当前状态：`done`
- 优先级：P2
...
1. 对照 `docs/02_specs/v1_domain_model_baseline.md` 与 `docs/02_specs/v1_information_architecture.md`，确认页面壳层与已冻结对象边界一致
