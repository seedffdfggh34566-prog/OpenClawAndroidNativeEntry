...
- 建议路径：`docs/03_tasks/task_v1_backend_api_contract.md`
- 当前状态：`done`
- 优先级：P2
...
- `docs/02_specs/v1_backend_api_contract.md`
- `docs/03_tasks/task_v1_backend_api_contract.md`
...
- `docs/02_specs/v1_domain_model_baseline.md`
- `docs/02_specs/v1_information_architecture.md`
...
1. 新增 `docs/02_specs/v1_backend_api_contract.md`
2. 新增当前 task 文档
3. 更新 `docs/03_tasks/README.md`
4. 新增 handoff 文档
