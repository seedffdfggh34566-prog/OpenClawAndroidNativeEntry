...
- 任务名称：V1 领域对象与状态基线
- 建议路径：`docs/03_tasks/task_v1_domain_model_baseline.md`
- 当前状态：`done`
- 优先级：P0
...
- 新建或补充 `docs/02_specs/` 下的领域对象基线说明
- 定义 V1 正式对象的最小字段分组
- 定义对象生命周期和最小状态集合
- 定义对象之间的引用方式
...
- `docs/02_specs/agent_runtime_and_data_architecture.md`
- `docs/02_specs/` 下新增领域对象 spec
- `docs/03_tasks/task_v1_domain_model_baseline.md`
- `docs/05_handoffs/` 下对应 handoff

参考文件：

- `docs/00_project_overview.md`
- `docs/01_prd/ai_sales_assistant_v1_prd.md`
- `docs/06_decisions/decision_001_backend_deployment_baseline.md`
...
1. 新增 `docs/02_specs/v1_domain_model_baseline.md`
2. 回链并收口 `docs/02_specs/agent_runtime_and_data_architecture.md`
...
1. 对照 `docs/00_project_overview.md`、`docs/01_prd/ai_sales_assistant_v1_prd.md`、`docs/02_specs/agent_runtime_and_data_architecture.md`、`docs/06_decisions/decision_001_backend_deployment_baseline.md`，确认未改变既有产品含义
