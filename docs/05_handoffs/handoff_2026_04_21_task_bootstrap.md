...
- 让 `docs/03_tasks/` 从空目录变成可直接驱动后续开发的任务入口
- 明确第一批任务的顺序、边界和依赖
...
- `docs/03_tasks/README.md`
- `docs/03_tasks/task_v1_domain_model_baseline.md`
- `docs/03_tasks/task_v1_information_architecture.md`
- `docs/03_tasks/task_v1_android_control_shell_refactor.md`
- `docs/05_handoffs/handoff_2026_04_21_task_bootstrap.md`
...
- 没有新增后端 contract
- 没有扩展 PRD 范围
- 没有改动人类主导的 `docs/00_project_overview.md`、`docs/01_prd/*`、`docs/06_decisions/*` 的含义
...
1. 文档与代码上下文核对
   - 已核对 `AGENTS.md`
   - 已核对 `docs/00_project_overview.md`
   - 已核对 `docs/01_prd/ai_sales_assistant_v1_prd.md`
   - 已核对 `docs/02_specs/agent_runtime_and_data_architecture.md`
...
- `docs/02_specs/` 中还缺少更具体的领域对象基线文档
...
1. `docs/03_tasks/task_v1_domain_model_baseline.md`
