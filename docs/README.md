...
该任务只做 Sales Workspace persistence schema design，不写 SQLAlchemy model 或 Alembic migration。
...
- 下一项唯一开放任务是 Sales Workspace persistence schema design。
