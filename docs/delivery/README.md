...
| `task_v2_sales_workspace_draft_review_contract.md` | 定义 Draft persistence / review history contract | `planned / recommended, not auto-queued` |
...
- 当前推荐下一阶段是 Draft persistence / review history contract。
