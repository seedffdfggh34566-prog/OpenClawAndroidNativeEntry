...
```bash
python3 scripts/run_backend_verify.py --workspace "$PWD" --mode tests
python3 scripts/run_backend_verify.py --workspace "$PWD" --mode migrate
python3 scripts/run_backend_verify.py --workspace "$PWD" --mode smoke
python3 scripts/run_backend_verify.py --workspace "$PWD" --mode full
```
