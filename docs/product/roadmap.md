...
> **V2.1 workspace/kernel engineering baseline completed；V2.1 conversational backend acceptance completed；V2.1 conversational product experience prototype completed**
...
- V2.1 conversational product experience：chat-first Runtime design、contract examples、trace persistence、backend prototype、Android chat-first UI、demo runbook 和 backend-level 5-sample conversational acceptance 已完成；V2.1 product experience prototype 已通过 Android polish 与真机验收。
