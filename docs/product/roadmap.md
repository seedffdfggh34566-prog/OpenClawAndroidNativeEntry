...
> **V2.1 workspace/kernel engineering baseline completed；V2.1 conversational backend acceptance completed；V2.1 conversational product experience remains incomplete**
...
- V2.1 conversational product experience：chat-first Runtime design、contract examples、trace persistence、backend prototype、Android chat-first UI、demo runbook 和 backend-level 5-sample conversational acceptance 已完成；完整 product experience 仍需 Android polish / device acceptance。
...
4. Backend-level V2.1 conversational acceptance 已完成；当前没有自动开放 implementation task。
...
- Android conversation polish / device acceptance。（planned / blocked）
